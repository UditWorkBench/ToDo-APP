...
export function TodoList({ todos, onDelete, onEdit }: Props) {
  ...
  if (todos?.length === 0) return <p className='no-todos-disclaimer'>No task yet. Please add</p>;

  return (
    <div className="todo-list">
        <div className="search-container">
            <input type="text" className="search-input" placeholder="Search To-Do" value={search} onChange={e => setSearch(e.target.value)}/>
